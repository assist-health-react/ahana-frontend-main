...
import InfirmaryList from './InfirmaryList';
...
const Infirmary = () => {
  ...
  const handleSearch = () => {
    // If using search bar, clear the name filter
  ...
  const handleApplyFilters = () => {
    // If name filter is applied, clear the search input
    if (filters.name) {
      setSearchTerm('');
      setActiveSearchTerm('');
    }
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
          <h1 className="text-2xl font-bold text-gray-800">Infirmary Records</h1>
