...
const StudentList = ({ 
  ...
  const getGenderIcon = (gender) => {
    console.log('Rendering gender icon for:', gender);
    ...
    if (normalizedGender === 'male') {
      ...
      // Default icon for undefined or other cases
      return <img src={boyStudentIcon} alt="Student" className="w-10 h-10 object-contain opacity-50" />;
    }
  };
