...
const SchoolsList = () => {
  ...
  useEffect(() => {
    ...
    if (!userData.userId || userData.userType !== 'nurse') {
      setError('Unauthorized access. Please login as a nurse.');
      setLoading(false);
      return;
    }
    fetchSchools();
  ...
  const fetchSchools = async () => {
    try {
      ...
      setError(err.message || 'Failed to fetch schools. Please try again later.');
      setSchools([]);
    } finally {
      setLoading(false);
    }
