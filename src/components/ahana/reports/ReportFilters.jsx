      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4">
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <Select
              value={filters.class ? { value: filters.class, label: filters.class } : null}
              onChange={(selected) => {
                console.log('Selected class:', selected?.value);
                onFilterChange('class', selected?.value || '');
          ...
          <div>
            ...
            <Select
              ...
              options={getAvailableSections(filters.class)}
              isDisabled={!filters.class || isLoading}
